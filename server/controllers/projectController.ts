...
export const makeRevision = async (req: Request, res: Response) => {
    ...
    try {
        ...
        await prisma.conversation.create({
            data: {
                role: 'assistant',
                content: `I've enhaced your prompt to: ${enhancedPrompt}`,
                projectId
            }
        })
        ...
        const codeGenerationResponse = await openai.chat.completions.create({
            ...
            messages: [
                ...
                {
                     role: 'user',
                    content: `Here is the current website code: "${currentProject.current_code}" The user wants this chnage: "${enhancedPrompt}"`
                }
            ]
        })
...
// controller for getting project for preview
