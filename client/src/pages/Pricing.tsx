    ...
    <>
      <div className='w-full max-w-5xl mx-auto z-20 max-md:px-4 min-h-[80vh]'>
        <div className='text-center mt-16'>
          ...
          <p className='text-gray-400 text-sm max-w-md mx-auto mt-2'>Start for free and scale up as you grow. Find the prefect plan for your content creation needs.</p>
        </div>
        <div className='pt-14 py-4 px-4 '>
          ...
          <p className='mx-auto text-center text-sm max-w-md mt-10 text-white/60 font-light'>Project <span className='text-white'> Creation / Revision</span> consume <span className='text-white'>5 credits </span>. You can purchase more credits to create more porjects.</p>
      </div>
      <Footer/>
    </>
  )
