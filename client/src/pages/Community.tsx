        ...
        <div className='px-4 md:px-16 lg:px-24 xl:px-32'>
            {loading ? (
                ...
                <div className='py-10 min-h-[80vh]'>
                    ...
                    <div className='flex flex-wrap gap-3.5'>
                        {projects.map((project) => (
                            <Link to={`/view/${project.id}`} target='_blank' key={project.id} className='w-72 max-sm:mx-auto cursor-pointer bg-gray-900/60 border border-gray-700 rounded-lg overflow-hidden group hover:border-indigo-800/80 transition-all duration-300'>
                ...
                <div className='flex flex-col items-center justify-center h-[80vh]'>
                    ...
                    <button onClick={() => navigate('/')} className='text-white px-5 py-2 mt-5 rounded-md bg-indigo-500 hover:bg-indigo-600 active:scale-95 translate-all'>
                        Create New
                    </button>
                </div>
            )}
